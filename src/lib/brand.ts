...
export function getBrand() {
  return {
    ...
    logo_url: `${CANONICAL_URL}window-replacement-plano-tx-logo.png`,
    city_state: "Plano, TX",
    brand_accent: "#ea580c",
    cta_dark_bg: "#111827",
    bg_color: "#111827",
    ...
    brand_tagline: 'Premium Window & Door Installation in Plano, TX',
    supportPhone: PHONE,
    supportEmail: EMAIL,
    service_area: 'Serving Plano and the Greater DFW Metroplex',
  };
}
