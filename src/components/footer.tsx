      ...
      <div className={styles.container}>
        <div className={styles.footerContent}>
          <div className={styles.footerBrand}>
            ...
            <p className={styles.footerTagline}>
              Transforming North Texas homes with premium windows.
            </p>
          ...
          <div className={styles.footerContact}>
            <p className={styles.footerLabel}>Please Call</p>
            <a href="tel:945-207-3988" className={styles.footerPhone}>945-207-3988</a>
            <a href="mailto:info@windowreplacementplano.com" className={styles.footerEmail}>
              INFO@WINDOWREPLACEMENTPLANO.COM
            </a>
            <address className={styles.footerAddress}>
              <a 
                href="https://maps.google.com/?q=5445+Legacy+Dr+%23160,+Plano,+TX+75024" 
                target="_blank" 
        ...
        <div className={styles.footerBottom}>
          <p className={styles.copyright}>
            &copy; {new Date().getFullYear()} WINDOW REPLACEMENTS OF PLANO. ALL RIGHTS RESERVED.
          </p>
