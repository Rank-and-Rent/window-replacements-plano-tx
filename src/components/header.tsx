    ...
    <>
      <header className={`${styles.header} ${isScrolled ? styles.scrolled : ''}`}>
        <div className={styles.container}>
          ...
          <a href="tel:945-207-3988" className={styles.phoneDesktop}>
            <span className={styles.phoneLabel}>Call Now</span>
            <span className={styles.phoneNumber}>945-207-3988</span>
          </a>
          ...
          <div className={styles.mobileActions}>
            <a href="tel:945-207-3988" className={styles.mobileCallBtn}>
              Call Now
            </a>
            <button
      ...
      <nav className={`${styles.mobileMenu} ${isMobileMenuOpen ? styles.mobileMenuOpen : ''}`}>
        ...
        <div className={styles.mobileMenuFooter}>
          <a href="tel:945-207-3988" className={styles.mobilePhoneButton}>
