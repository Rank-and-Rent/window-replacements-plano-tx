...
export const metadata: Metadata = {
  ...
  description: 'Professional window replacement in Plano, Texas. Serving Plano neighborhoods, and all Plano neighborhoods. Premium Andersen, Pella & Jeld-Wen windows. Call 945-207-3988.',
}
  ...
  return (
    <>
      ...
      <main>
        ...
        <section className={styles.hero} style={{ backgroundImage: 'url(/locations/window-replacement-plano-tx-4.jpg)' }}>
          <div className={styles.heroOverlay}></div>
          <div className={styles.heroContent}>
            <h1>Window Replacement in Plano, TX</h1>
            <p>Serving Plano with premium replacement windows. From historic homes to modern developments, we deliver quality installations backed by manufacturer warranties.</p>
          ...
          <div className={styles.container}>
            <div className={styles.grid}>
              <div className={styles.imageCol}>
                <img
                  src="/locations/window-replacement-plano-tx-4.jpg"
              ...
              <div className={styles.textCol}>
                <h2>Window expertise for Plano's communities</h2>
                <p>Plano's diverse neighborhoods create unique opportunities for window replacement projects. From established residential areas to newer developments, we understand the architectural diversity that makes each home unique. Our experienced team brings specialized knowledge for Plano's building styles and homeowner preferences.</p>
                <p>The city's location creates specific climate considerations. Plano homes benefit from enhanced energy-efficient solutions that address local weather patterns and solar exposure. We ensure optimal energy efficiency and comfort throughout your Plano home.</p>
                <p>As a locally-based company, we take pride in serving our Plano neighbors. Our transparent pricing, professional installations, and comprehensive warranties have made us the trusted choice for window replacement throughout Plano's communities.</p>
              </div>
            </div>
          </div>
        </section>
      ...
      <section className="py-20 bg-stone-100">
        <div className="max-w-[1200px] mx-auto px-6 lg:px-12">
          ...
          <div className="grid md:grid-cols-3 gap-6 text-sm">
            ...
            <div>
              <h3 className="text-[11px] tracking-[0.2em] uppercase font-medium text-charcoal-900 mb-3">North Plano</h3>
