    ...
    brands: [
      {
        ...
        description: 'Andersen\&apos;s traditional wood line offers authentic wood windows crafted from premium species with time-honored construction methods. Their windows combine historical accuracy with modern performance features for discerning Plano homeowners.',
      },
      {
        name: 'Pella Wood Windows',
        description: 'Pella crafts solid wood windows using premium wood species and advanced preservation treatments. Their wood windows provide authentic beauty with enhanced longevity, perfect for Plano\&apos;s historic homes and traditional architecture.',
      },
      {
        name: 'JELD-WEN Premium Wood Collection',
        description: 'JELD-WEN\&apos;s premium wood windows feature authentic construction using select wood species. Their AuraLast preservation system extends wood life while maintaining traditional appearance, ideal for Plano\&apos;s climate.',
      },
    ],
    ...
    faq: [
      {
        ...
        answer: 'Yes, solid wood windows require regular maintenance. Exterior surfaces need repainting or refinishing every 3-5 years in Plano\&apos;s climate to prevent moisture damage and UV degradation. However, many homeowners find this maintenance rewarding.',
      },
      {
        question: 'How long do wood windows last?',
        answer: 'With proper maintenance, quality wood windows last 50-100 years or more. They can be refinished repeatedly, allowing homeowners to refresh appearance without replacement. Many Plano homes feature original wood windows from the 1920s-1940s.',
      },
      {
      ...
      },
      {
        ...
        answer: 'Many Plano historic districts require wood windows to maintain period authenticity. Even when not mandated, wood windows are essential for authentic historic preservation and maintaining property value in historic neighborhoods.',
      },
      {
