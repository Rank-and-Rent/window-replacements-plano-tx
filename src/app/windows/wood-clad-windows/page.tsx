...
export default function WoodCladWindowsPage() {
  const content = {
    title: 'Wood Clad Windows Replacement in Plano, TX',
    subtitle: 'Authentic Wood Interior Beauty with Weather-Resistant Exterior Protection',
    heroImage: '/window-types/wood-clad-plano-tx.jpg',

    intro: "Plano homeowners seeking the ultimate combination of traditional wood beauty and modern durability discover that wood clad windows provide the perfect balance. With authentic wood interiors that bring natural warmth to your home and weather-resistant exteriors that withstand Plano&apos;s challenging climate, wood clad windows represent the gold standard in window performance and aesthetics.",
    ...
    sections: [
      ...
      {
        heading: 'Weather Protection for Plano Climate',
        content: "The exterior cladding creates an impenetrable barrier against moisture, UV exposure, and temperature extremes that damage traditional wood windows in Plano. Unlike bare wood that requires annual maintenance, clad exteriors need minimal care while providing decades of weather protection. The cladding prevents rot, warping, and insect damage that plague unprotected wood in Texas climate.",
      },
      {
        heading: 'Superior Energy Efficiency',
        content: "Wood\&apos;s natural insulating properties combined with modern cladding technology create exceptional thermal performance. Wood clad windows typically achieve U-factors of 0.25-0.30, significantly better than aluminum and comparable to premium vinyl. Plano homeowners see 30-40% reductions in energy costs compared to older windows, with the added benefit of wood\&apos;s thermal mass that moderates temperature swings.",
      },
      {
      ...
      },
      {
        ...
        content: "Wood clad windows significantly enhance home value and appeal in Plano\&apos;s upscale real estate market. The natural wood interior creates warmth and character that buyers value, while the low-maintenance exterior appeals to practical considerations. Wood clad windows are often cited as a key selling feature in premium Plano properties.",
      },
    ],
    ...
    brands: [
      ...
      },
      {
        ...
        description: 'Pella\&apos;s wood clad windows combine authentic wood beauty with their proprietary EnduraClad protection system. The result is windows that perform beautifully in Plano\&apos;s challenging climate while maintaining traditional appeal.',
      },
      {
    ...
    faq: [
      ...
      },
      {
        ...
        answer: 'Yes, wood clad windows are highly energy efficient. Wood\&apos;s natural insulating properties combined with modern glass technology can reduce energy costs by 30-40% in Plano\&apos;s climate.',
      },
      {
      ...
      },
      {
        ...
        answer: 'Absolutely. Wood clad window interiors accept any stain or paint, allowing perfect color matching with your Plano home\&apos;s interior design. Many homeowners change interior finishes over time.',
      },
      {
